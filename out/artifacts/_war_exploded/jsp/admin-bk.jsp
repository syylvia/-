...
<div class="templatemo-flex-row">
    <div class="templatemo-sidebar">
        ...
        <nav class="templatemo-left-nav">
            <ul>
                ...
                <li><a href="../adminModule?type=bk" class="active"><i class="fa fa-map-marker fa-fw"></i>党史大百科</a></li>
    ...
    <%
        ...
        ArrayList<Title> k=(ArrayList<Title>)application.getAttribute("bk1ArrayList");
        ArrayList<Comment> k2=(ArrayList<Comment>)application.getAttribute("bkcomm1ArrayList");
            ...
            <div class="row">
                <nav class="templatemo-top-nav col-lg-12 col-md-12">
                    <ul class="text-uppercase">
                        <li><a href="../admin-index.jsp" class="active">系统参数</a></li>
                ...
                <div class="col-1">
                    <div class="panel panel-default templatemo-content-widget white-bg no-padding templatemo-overflow-hidden">
                        ...
                        <div class="panel-heading templatemo-position-relative" style="height: 40px">
                            <a style="display: block;margin-top:-10px;color: white;font-size:18px;float: left" href="../paging?model=bk&type=title">党史大百科</a>
                            <a href="admini-addtitle.jsp?type=bk" style="float: left; margin-top: -8px;color: white;margin-left: 30px;">增加文章</a>
                        </div>
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <tr>
                                ...
                                <td style="font-size: 14px;" >
                                    <a href="../adminLook?type=bk&name=<%=title.getName()%>" style="margin-right: 5px;">查看</a>
                                    <a href="../deleteTitle?type=bk&name=<%=title.getName()%>" style="margin-right: 5px;">删除</a>
                                    <a href="../changeTitle?type=bk&name=<%=title.getName()%>">修改</a></td>
                            </tr>
                            <%
                                }
                            %>
        ...
        <div class="templatemo-content-container">
            <div class="templatemo-flex-row flex-content-row">
                <div class="col-1">
                    <div class="panel panel-default templatemo-content-widget white-bg no-padding templatemo-overflow-hidden">
                        <i class="fa fa-times"></i>
                        <div class="panel-heading templatemo-position-relative"><a href="../paging?model=bk&type=comment" style="text-decoration: none;"><h2 class="text-uppercase">党史大百科评论</h2></a></div>
                        <div class="table-responsive"></div>
                        <table class="table table-striped table-bordered">
                            <thead>
                            <tr>
