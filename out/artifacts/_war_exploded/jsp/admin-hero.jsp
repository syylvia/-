    ...
    <div class="templatemo-sidebar">
        ...
        <nav class="templatemo-left-nav">
            <ul>
                ...
                <li><a href="../adminModule?type=hero" class="active"><i class="fa fa-bar-chart fa-fw"></i>红色英雄</a></li>
...
<%
    ...
    ArrayList<Hero> k=(ArrayList<Hero>)application.getAttribute("hero1ArrayList");
    ArrayList<Comment> k2=(ArrayList<Comment>)application.getAttribute("herocomm1ArrayList");
            ...
            <div class="col-1">
                <div class="panel panel-default templatemo-content-widget white-bg no-padding templatemo-overflow-hidden">
                    ...
                    <div class="panel-heading templatemo-position-relative" style="height: 40px">
                        <a style="display: block;margin-top:-10px;color: white;font-size:18px;float: left" href="../paging?model=hero&type=title">红色英雄表</a>
                        <a href="admini-addtitle.jsp?type=hero" style="float: left; margin-top: -8px;color: white;margin-left: 30px;">增加文章</a>
                    </div>
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <tr>
                            ...
                            <td style="font-size: 14px;" >
                                ...
                                <a href="../changeTitle?type=hero&name=<%=hero.getName()%>">修改</a>
                            </td>
                        </tr>
                        <%
                            }
    ...
    <div class="templatemo-content-container">
        <div class="templatemo-flex-row flex-content-row">
            <div class="col-1">
                <div class="panel panel-default templatemo-content-widget white-bg no-padding templatemo-overflow-hidden">
                    <i class="fa fa-times"></i>
                    <div class="panel-heading templatemo-position-relative"><a href="../paging?model=hero&type=comment" style="text-decoration: none;"><h2 class="text-uppercase" style="color: white">红色英雄表评论</h2></a></div>
                    <div class="table-responsive"></div>
                    <table class="table table-striped table-bordered">
                        <thead>
                        <tr>
