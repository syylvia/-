...
<div class="templatemo-flex-row">
    <div class="templatemo-sidebar">
        <header class="templatemo-site-header">
            <div class="square"><img src="../img/logo2.png"></div>
            <h1>江西红色在线</h1>
        </header>
        <div class="profile-photo-container">
            <img src="../img/bg_header2.jpg" alt="Profile Photo" class="img-responsive">
                ...
                <div class="col-1">
                    <div class="panel panel-default templatemo-content-widget white-bg no-padding templatemo-overflow-hidden">
                        ...
                        <div class="panel-heading templatemo-position-relative" style="height: 40px">
                            <a style="display: block;margin-top:-10px;color: white;font-size:18px;float: left">红色故事表</a>
        ...
        <div class="templatemo-content-container">
            <div class="templatemo-flex-row flex-content-row">
                <div class="col-1">
                    <div class="panel panel-default templatemo-content-widget white-bg no-padding templatemo-overflow-hidden">
                        <i class="fa fa-times"></i>
                        <div class="panel-heading templatemo-position-relative"><a href="#" style="text-decoration: none;"><h2 class="text-uppercase">红色故事表评论</h2></a></div>
                        <div class="table-responsive"></div>
                        <table class="table table-striped table-bordered">
                            <thead>
                            <tr>
