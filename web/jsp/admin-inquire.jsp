...
<div class="templatemo-flex-row">
    <div class="templatemo-sidebar">
        ...
        <nav class="templatemo-left-nav">
            <ul>
                ...
                <li><a href="../adminModule?type=inquire" class="active"><i class="fa fa-users fa-fw"></i>红色寻访</a></li>
    ...
    <%
        ...
        ArrayList<Title> k=(ArrayList<Title>)application.getAttribute("inquire1ArrayList");
        ArrayList<Comment> k2=(ArrayList<Comment>)application.getAttribute("inquirecomm1ArrayList");
                ...
                <div class="col-1">
                    <div class="panel panel-default templatemo-content-widget white-bg no-padding templatemo-overflow-hidden">
                        ...
                        <div class="panel-heading templatemo-position-relative" style="height: 40px">
                            <a style="display: block;margin-top:-10px;color: white;font-size:18px;float: left" href="../paging?model=inquire&type=title">红色寻访</a>
                            <a href="admini-addtitle.jsp?type=inquire" style="float: left; margin-top: -8px;color: white;margin-left: 30px;">增加文章</a>
                        </div>
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <tr>
                                ...
                                <td style="font-size: 14px;" >
                                    <a href="../adminLook?type=inquire&name=<%=title.getName()%>" style="margin-right: 5px;">查看</a>
                                    <a href="../deleteTitle?type=inquire&name=<%=title.getName()%>" style="margin-right: 5px;">删除</a>
                                    <a href="../changeTitle?type=inquire&name=<%=title.getName()%>">修改</a></td>
                            </tr>
                            <%
                                }
                            %>
