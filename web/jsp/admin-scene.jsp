...
<div class="templatemo-flex-row">
    <div class="templatemo-sidebar">
        ...
        <nav class="templatemo-left-nav">
            <ul>
                ...
                <li><a href="../adminModule?type=scene" class="active"><i class="fa fa-database fa-fw"></i>红色圣地</a></li>
    ...
    <%
        ...
        ArrayList<Title> k=(ArrayList<Title>)application.getAttribute("scene1ArrayList");
        ArrayList<Comment> k2=(ArrayList<Comment>)application.getAttribute("scenecomm1ArrayList");
                ...
                <div class="col-1">
                    <div class="panel panel-default templatemo-content-widget white-bg no-padding templatemo-overflow-hidden">
                        ...
                        <div class="panel-heading templatemo-position-relative" style="height: 40px">
                            <a style="display: block;margin-top:-10px;color: white;font-size:18px;float: left" href="../paging?model=scene&type=title">红色圣地表</a>
                            <a href="admini-addtitle.jsp?type=scene" style="float: left; margin-top: -8px;color: white;margin-left: 30px;">增加文章</a>
                        </div>
