...
@WebServlet("/adminLook")
public class adminLook extends HttpServlet {
        ...
        try {
            ...
            if(type.equals("hero")) {
                ...
                if (rs.next()) {
                    ...
                    //请求重定向
                    response.sendRedirect("/Graduation-project/jsp/admin-look.jsp?type=hero");
                }
                ...
                if (rs.next()) {
                    ...
                    //request.getRequestDispatcher("/title.jsp").forward(request, response);//请求转发
                    //请求重定向
                    response.sendRedirect("/Graduation-project/jsp/admin-look.jsp?type=story");
                }
                ...
                if (rs.next()) {
                    ...
                    //request.getRequestDispatcher("/title.jsp").forward(request, response);//请求转发
                    //请求重定向
                    response.sendRedirect("/Graduation-project/jsp/admin-look.jsp?type=scene");
                }
                ...
                if (rs.next()) {
                    ...
                    //request.getRequestDispatcher("/title.jsp").forward(request, response);//请求转发
                    //请求重定向
                    response.sendRedirect("/Graduation-project/jsp/admin-look.jsp?type=bk");
                }
                ...
                if (rs.next()) {
                    ...
                    //request.getRequestDispatcher("/title.jsp").forward(request, response);//请求转发
                    //请求重定向
                    response.sendRedirect("/Graduation-project/jsp/admin-look.jsp?type=inquire");
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
